...
function useTooltip(_temp) {
  ...
  var ref = utils.useForkedRef(forwardedRef, ownRef); // TODO: Fix in utils

  var triggerRect = rect.useRect(ownRef, isVisible);
  ...
  React.useEffect(function () {
    return utils.checkStyles("tooltip");
  }, []);
  React.useEffect(function () {
...
var Tooltip = /*#__PURE__*/utils.forwardRefWithAs(function (_ref2, forwardedRef) {
  ...
  var child = React.Children.only(children);
   utils.warning(!DEPRECATED_ariaLabel, "The `ariaLabel prop is deprecated and will be removed from @reach/tooltip in a future version. Please use `aria-label` instead.") ; // We need to pass some properties from the child into useTooltip
  ...
  return React__default['default'].createElement(React.Fragment, null, React.cloneElement(child, trigger), React__default['default'].createElement(TooltipPopup, Object.assign({
    ref: forwardedRef,
    label: label,
...
var TooltipPopup = /*#__PURE__*/utils.forwardRefWithAs(function TooltipPopup(_ref3, forwardRef) {
  ...
  return isVisible ? React__default['default'].createElement(Portal__default['default'], null, React__default['default'].createElement(TooltipContent, Object.assign({
    ref: forwardRef,
    label: label,
    "aria-label": DEPRECATED_ariaLabel,
    isVisible: isVisible
...
var TooltipContent = /*#__PURE__*/utils.forwardRefWithAs(function TooltipContent(_ref4, forwardedRef) {
  ...
  var tooltipRect = rect.useRect(ownRef, isVisible);
  return React__default['default'].createElement(React.Fragment, null, React__default['default'].createElement(Comp, Object.assign({
  ...
  }), label), hasAriaLabel && React__default['default'].createElement(VisuallyHidden__default['default'], {
    role: "tooltip",
    id: id
